 ...
 *
 */
class AlbunsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'data_album' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'usuario_key' => ['type' => 'index', 'columns' => ['usuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'albuns_ibfk_1' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'data_album' => '2017-03-15',
            'data_criacao' => '2017-03-15 22:29:10',
            'data_atualizacao' => '2017-03-15 22:29:10'
        ],
    ];
}
