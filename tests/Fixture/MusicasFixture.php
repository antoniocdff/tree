...
class MusicasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'musica_key' => ['type' => 'index', 'columns' => ['usuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'musicas_ibfk_1' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'data_criacao' => '2017-03-15 22:29:15',
            'data_atualizacao' => '2017-03-15 22:29:15',
            'ordem' => 1
        ],
    ];
}
