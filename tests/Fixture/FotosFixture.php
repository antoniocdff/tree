...
class FotosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'data_foto' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'album_key' => ['type' => 'index', 'columns' => ['album_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fotos_ibfk_1' => ['type' => 'foreign', 'columns' => ['album_id'], 'references' => ['albuns', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'data_foto' => '2017-03-15',
            'data_criacao' => '2017-03-15 22:29:18',
            'data_atualizacao' => '2017-03-15 22:29:18'
        ],
    ];
}
